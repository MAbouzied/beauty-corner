...
export const doctors: readonly Doctor[] = [
  ...
  {
    id: 'dentistry-mahmoud',
    name: 'د. محمود جمعة',
    title: 'طبيب أسنان',
    specialty: 'طب وتجميل الأسنان',
    branch: 'حفر الباطن',
    services: ['استشارة', 'جلسة علاج', 'متابعة'],
    image: '/assets/doctor-mahmoud.png',
    summary: 'طبيب أسنان يهتم بالتشخيص الدقيق والعلاج الوظيفي والتجميلي بما يناسب حالة كل مريض.',
    experienceYears: 12,
    sections: [
      {
        title: 'نبذة عن الطبيب',
        paragraphs: [
          'يقدّم د. محمود جمعة رعاية أسنان متكاملة تجمع بين الدقة والوضوح، مع بناء خطة علاجية تناسب أولويات الحالة.',
        ],
      },
      {
        title: 'مجالات التركيز',
        listItems: [
          'علاج الأسنان الترميمي',
          'العناية الوقائية والمتابعة',
          'تجميل الابتسامة وفق تقييم طبي',
        ],
      },
      {
        title: 'أسلوب الرعاية',
        paragraphs: [
          'يعتمد نهجاً واضحاً يبدأ بالتقييم ثم اختيار الحل الأنسب، مع الحرص على راحة المريض وشرح كل خطوة قبل العلاج.',
        ],
      },
    ],
  },
